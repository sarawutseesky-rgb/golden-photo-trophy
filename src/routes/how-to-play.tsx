...
const STEPS = [
  {
    ...
    body: "อัปโหลดได้วันละ 1 รูป เลือกรูปที่ภูมิใจที่สุด ใส่ชื่อ คำอธิบาย และแท็ก เพื่อให้คนค้นเจอง่ายขึ้น",
...
const FAQS = [
  ...
  },
  {
    ...
    a: "สมาชิกทุกคนอัปโหลดได้วันละ 1 รูป เลือกชุดที่ดีที่สุดของวันนั้นให้ดี ๆ",
  },
  {
