    ...
    <div className="relative -mx-4 -my-6 flex min-h-[calc(100vh-4rem)] items-center justify-center overflow-hidden px-6 py-12">
      ...
      <div className="relative w-full max-w-[420px]">
        <div className="mb-8 text-center">
          ...
          <p className="text-sm text-muted-foreground">สร้างบัญชีฟรี เริ่มแชร์ผลงานภาพถ่ายของคุณ</p>
        </div>
          ...
          <div className="space-y-6">
            ...
            <form onSubmit={onSubmit} className="space-y-4">
              <div className="space-y-1.5">
                <label htmlFor="displayName" className="ml-1 text-xs font-medium text-muted-foreground">
                  ชื่อที่แสดง
                </label>
                <input
                  id="displayName"
              ...
              <div className="space-y-1.5">
                <label htmlFor="password" className="ml-1 text-xs font-medium text-muted-foreground">
                  Password
                </label>
                <input
                  id="password"
              ...
              >
                {loading ? "กำลังสร้างบัญชี…" : "สมัครฟรี"}
              </button>
            </form>
