...
// and closes cleanly via the Escape key without a blank screen or pageerror.
test.describe("Photo detail — lightbox Escape close", () => {
  test("hard refresh, open lightbox, close via Escape key", async ({ page }) => {
    ...
    // Close via Escape key (default yet-another-react-lightbox keyboard).
